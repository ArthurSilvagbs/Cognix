...
| Estudar o de ontem (banner) | **Não resolve as pendências** — puxa o próximo estudo de ontem para o foco de agora (hero + item 1 da fila). O banner **persiste** com a contagem do que resta ("Ainda há N pendências de ontem"), o item ganha selo "em foco agora" (primária) na sanfona, e o botão some quando não há mais estudos de ontem. Hoje acumula: o atrasado + o que já era de hoje — dia mais pesado por escolha consciente. Só o Replanejar (ou zerar a fila) remove o banner | toast: "X em foco. O restante de ontem continua no banner." |
